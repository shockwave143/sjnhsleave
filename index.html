            ...
            <div class="preloader-wrapper big active">
                ...
                <div class="spinner-layer spinner-green">
                    ...
                    <div class="circle"></div>
                            ...
                            <style type="text/css">
            body {
                background-image: url("deped1.jpg");
        ...
        <div class="white">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index1.php"><i class="material-icons">account_box</i>Employee Login</a></li>
                ...
                <div class="row">
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
                                  ...
                                  <div class="center ">
                                      <span class="center" style="font-size:20px;">DepEd Employee Leave Management</span>
                                       <div class="row">
                                      </div>
                                  </div>
                              </div>
